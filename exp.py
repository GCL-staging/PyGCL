...
def resolve_param_path(dataset: str, mode: Mode, objective: Objective):
    ...
    objective_suffix = {
        ...
        Objective.BL: '_bl',
        Objective.Debiased: '_debiased',
        Objective.Hardness: '_hardness',
        Objective.Ring: '_ring'
    }
...
class GCLJob(Job):
    ...
    def resolve(self, worker_id: int) -> List[Command]:
        objective_name = {
            ...
            Objective.Debiased: 'debiased_infonce',
            Objective.Hardness: 'hardness_infonce',
            Objective.Ring: 'ring_loss'
        }
        train_script = {
            TaskType.NodeTask: {
...
@register_runner
def hard_negative_objectives():
    jobs = []

    datasets = ['WikiCS', 'Amazon-Computers', 'Coauthor-CS']
    objectives = [Objective.Debiased, Objective.Hardness, Objective.Ring]
